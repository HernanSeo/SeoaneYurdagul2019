...
!      implicit none
!
!      integer zznvar,zznlag,zzns,zzthet,zzpmat,zziw,zznst,zziw2,  zziw3,
!     &zzw  ,nvaln ,nlag,nrquad ,nvar
...
!      end module   global
      ...
      REAL*8 WORK1(ZZNST),WORK2(ZZNST)
       ...
       open(unit=10,file='outputs/paramvar.txt')         ! read output of  var

      OPEN(UNIT=3,FILE='outputs/COVfinal.TXT')
      OPEN(UNIT=11,FILE='outputs/GHQUAD.DAT')                 ! read files
...
10    CONTINUE
! this loads the following y=B+A*yback+SIG
      CALL HEADER('/B//_')
