...
integer, parameter :: n_b=200,n_z=25,n_g=11,n_kappa=1,n_omega=1,n_id=2000,n_time=500
...
mu_sim, pn_sim,randomkappa,randomomega,randomg,tax_sim
...
integer id,t,i,j,lt,ii,h,x,tr,ltnext,hnext,xnext,trnext
...
!       pause
          ...
          open (UNIT=21, FILE="outputs\data_sim.txt", status = 'replace')
              ...
              do id=1,n_id
              do t=1,n_time
WRITE(21,'(I4,A,I5,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,F12.8,A,&
&F18.5,A,F18.5,A,F18.5,A,F18.5,A,F14.5)') &
id,',',t,',',b_sim(id,t),',',nothing(1),',',nothing(1),',',ztvect(z_sim(id,t)),',',znvect(z_sim(id,t))&
,',',c_sim(id,t),',',ct_sim(id,t),',',cn_sim(id,t),',',yt_sim(id,t),',',yn_sim(id,t),',',pn_sim(id,t)&
,',',mu_sim(id,t),',',kappavect(kappa_sim(id,t)),',',omegavect(omega_sim(id,t)),',',gvect(g_sim(id,t)),',',tax_sim(id,t)
              enddo
              enddo
         close(21)
